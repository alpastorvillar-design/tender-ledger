...
[ingestion.md](ingestion.md). The publication calendar is still a later slice;
scheduling a run is [orchestration.md](orchestration.md), and monthly packages and a sequential
